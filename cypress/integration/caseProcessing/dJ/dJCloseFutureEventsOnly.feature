@smc
Feature: DJ Close Future Events only
    ...
    Scenario: Dispose Case
        ...
        And Civil Disposition Event Closure window displays with open future events
        #Test steps
        Given Click Close All Open Future Events button
        #Expected results
        Then Future event displays HRCAN Hearing Trial Cancelled with current date and time Past events remain open
        #Test steps
        Given Click Save
        #Expected results
